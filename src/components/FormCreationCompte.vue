                  ...
                  <v-col>
                    ...
                    <v-dialog v-model="dialog" persistent max-width="450">
                      ...
                      <v-card>
                        ...
                        <v-card-text
                          >Le SIREN renseigné correspond à l'établissement
                          suivant : <b>{{ checkSirenAPI }}</b></v-card-text
                        >
                        <v-card-actions>
                          <v-spacer></v-spacer>
                          <v-btn
...
export default Vue.extend({
  ...
  data() {
    return {
      ...
      sirenEtab: "" as string,
      sirenEtabRules: [
        (v: never) => !!v || "SIREN obligatoire",
        (v: never) => /^\d{9}$/.test(v) || "Le SIREN doit contenir 9 chiffres"
      ],
      ...
      confirmEmailContactRules: [
        (v: never) => !!v || "Vous devez confirmer l'adresse mail du contact"
      ],
