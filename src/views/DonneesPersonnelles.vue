      ...
      <v-row align="center" justify="center">
        <div style="padding: 20px;">
          ...
          <p>
            ...
            l’Inist-CNRS (ISTEX, PANIST). Elles sont conservées pendant la durée
            d'exercice de l'activité de l'agent concerné, et sont destinées aux
            personnes en charge des accès des établissements bénéficiaires aux
            ressources citées (éditeurs, équipes de l’Abes, de l’Inist-CNRS et
            du consortium Couperin.org).
            <br />
            ...
            d'accès aux données vous concernant et les rectifier. Pour toute
            question,
          ...
          interactivité et la qualité de ses services. Types de cookies déposés
          sur ce site :
          <br /><br />
          <h4 class="title">
          ...
          <p>
            ...
            L'application Licences Nationales ne peut donc en aucun cas remonter
            par ce biais à une personne physique.
          </p>
          <p>
